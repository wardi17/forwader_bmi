            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4">
                            <input type="text" value="<?= $items["jenisbarang"] ?>" id="jenisbarang" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-2">
                            <input type="text" value="<?= $items["hscode"] ?>" id="hscode" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" value="<?= $items["jumlah_volume"] ?>" id="jumlah_volume" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" value="<?= $items["pelabuhan_tujuan"] ?>" class="form-control" id="pelabuhan_tujuan">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" value="<?= $items["no_invoice"] ?>" id="no_invoice">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" value="<?= $items["shippingline"] ?>" id="shippingline" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="no_bl_awb" value="<?= $items["no_bl_awb"] ?>" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="container_no" value="<?= $items["container_no"] ?>" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="vessel_voyage" value="<?= $items["vessel_voyage"] ?>" class="form-control">
                        </div>
                    ...
                    <div class="col-md-6 text-end mt4">
                        <button class="btn btn-info me-1 mb-3" id="Update">Update</button>
                        <button class="btn btn-danger me-1 mb-3" id="DeleteData">Delete</button>

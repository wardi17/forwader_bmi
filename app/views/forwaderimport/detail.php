        ...
        <div class="card">
            <div class="card-header">
                <div class="row col-md-12">
                    <div class="col-md-1">
                        <button id="kembalidetail" type="button" class="btn btn-lg text-start">
                ...
                <form>
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="col-md-6 text-end mt4">
                                           <button  class="btn btn-secondary me-1 mb-3" id="bataldetail">Kembali</button>
...
<script>
      $(document).on("click","#kembalidetail ,#bataldetail",function(even){
        even.preventDefault();
        goBackDetail();
    });
    ...
    window.location.replace(`<?=base_url?>/import/put`);
}
</script>
